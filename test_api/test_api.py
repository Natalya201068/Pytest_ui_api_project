...
@pytest.mark.api
def test_get_film_with_query(api) -> None:
    query = 'Transformers'
...
@pytest.mark.api
def test_get_film_with_id(api) -> None:
    film_id = 301
...
@pytest.mark.api
def test_get_series_with_id(api) -> None:
    series_id = 1224067
...
@pytest.mark.api
def test_get_director_with_id(api) -> None:
    director_id = 196131
...
@pytest.mark.api
def test_get_film_with_bad_id(api) -> None:
    film_id = 1234567890
    status_code, film_name = api.get_film_with_id(film_id)
